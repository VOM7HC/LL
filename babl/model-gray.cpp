...
static void components(void)
{
    babl_component_new("Y", "id", BABL_GRAY_LINEAR, "luma", NULL);

    babl_component_new("Ya", "id", BABL_GRAY_LINEAR_MUL_ALPHA, "luma", NULL);

    babl_component_new("Y'", "id", BABL_GRAY_NONLINEAR, "luma", NULL);

    babl_component_new("Y'a", "id", BABL_GRAY_NONLINEAR_MUL_ALPHA, "luma", NULL);
...
static void rgba_to_graya(Babl* conversion,
    char* src,
    char* dst,
    long n)
{
    ...
    while (n--) {
        ...
        luminance = red * RGB_LUMINANCE_RED + green * RGB_LUMINANCE_GREEN + blue * RGB_LUMINANCE_BLUE;
...
static void gray_alpha_associated_alpha_to_rgba_float(Babl* conversion, int src_bands, char** src, int* src_pitch, int dst_bands,
    char** dst,
    int* dst_pitch,
    long n)
{
