...
FILE* _babl_fopen(const char* path,
    const char* mode)
{
#ifndef _WIN32
...
int _babl_rename(const char* oldname,
    const char* newname)
{
#ifndef _WIN32
...
int _babl_stat(const char* path,
    BablStat* buffer)
{
#ifndef _WIN32
...
int _babl_mkdir(const char* path,
    int mode)
{
#ifndef _WIN32
...
void _babl_dir_foreach(const char* path,
