...
static void
cmyka_to_cmykA(const Babl* conversion, int8_t* src, int8_t* dst, long n)
{
    while (n--) {
...
static void cmykA_to_cmyka(const Babl* conversion, int8_t* src, int8_t* dst, long n)
{
    while (n--) {
        double alpha = ((double*)src)[4];
        double used_alpha = babl_epsilon_for_zero(alpha);
...
static void cmyk_to_cmyka(const Babl* conversion, int8_t* src, int8_t* dst, long n)
{
    while (n--) {
        double cyan = ((double*)src)[0];
        double magenta = ((double*)src)[1];
...
static void cmyka_to_cmyk(const Babl* conversion, char* src, char* dst, long n)
{
    while (n--) {
        double cyan = ((double*)src)[0];
        double magenta = ((double*)src)[1];
