    ...
    double f)
{
    ...
    if (fabs(g - 2.400) < 0.01 && fabs(a - 0.947) < 0.01 && fabs(b - 0.052) < 0.01 && fabs(c - 0.077) < 0.01 && fabs(d - 0.040) < 0.01 && fabs(e - 0.000) < 0.01 && fabs(f - 0.000) < 0.01)
